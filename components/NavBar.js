...
function NavBar() {
  return (
    <div className="font-sans">
      <nav class="bg-[#161616] border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-[#161616]-800">
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div class="flex md:order-2">
            <button
              type="button"
              class="text-white bg-gradient-to-bl from-[#FF9C37] via-[#F20242] to-[#AE2B8C] font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 "
            >
              Get started
            </button>
            <button
          ...
          >
            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
              <li>
                <a
                  href="#"
                  class="block py-2 pr-4 pl-3 text-white rounded bg-transparent md:p-0 "
                  aria-current="page"
                >
                  Home
                </a>
